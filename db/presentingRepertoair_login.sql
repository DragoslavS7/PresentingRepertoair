...
CREATE TABLE `login` (
  ...
  `log_email` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
  `log_password` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
...
INSERT INTO `login` VALUES (1,'gagi.predojevic932@hotmail.com','admin','2018-06-03 21:36:47');
