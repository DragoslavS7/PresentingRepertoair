...
<div class="sc-box">
    <div class="row">
        <div class="col-12 col-md-8">
            ...
            <a href="?page=his" class="btn btn-warning  btn-lg btn-block">History...</a>
        </div>
        <div class="col-6 col-md-4">
            <div class="">
                <h5 class="text-center">Small Scene</h5>
                <img class="rounded mx-auto d-block" src="asset/img/Rijeka005-300x200.jpg" width="">
            </div>
            <div>
                <h5 class="text-center">Big Scene</h5>
                <img class="rounded mx-auto d-block" src="asset/img/veseli-muzicari-01.jpg" width="">
            </div>
        </div>
    </div>
</div>
